...
define('modules/socialShareModule', ['jquery'], function ($) {
    ...
    var init = function () {
        console.log('Social sharing module init');
...
define('modules/collapsibleModule', [
    ...
    var init = function () {
        console.log('CollapsibleModule module init');
...
define('modules/accordionModule', [
    ...
    var init = function () {
        console.log('AccordionModule module init');
        _accordionModule._createAccordion();
    };
    var createAccordion = function (context) {
        console.log('interim createAccordion');
...
define('modules/filterModule', ['jquery'], function ($) {
    'use strict';
    var _settings = {
    ...
    var _filterModule = {
        ...
        filterItemsBy: function (filterName) {
            if (animtionHandler) {
                console.log('animtionHandler.stop');
    ...
    var init = function (wowInstance) {
        console.log('Filter section init');
...
define('modules/animationDelayModule', [
    ...
    var _animationDelayMod = {
        init: function () {
            console.log('Animation delay JS init here!');
    ...
    var init = function () {
        console.log('Animaitondelay module init');
...
], function ($, FastClick, DatePicker, TableSaw, Wow, Helpers, MenuModule, SocialShareModule, AccordionModule, TabsModule, FilerModule, MatchHeightsModule, AnimationDelayModule, SearchModule) {
    var main = {
        init: function () {
...
require([
    ...
    'use strict';
    domReady(function () {
        console.log('app.js - domReady + main loaded');
        main.init();
    });
});
define('app', [
