Feature: CurrentlyInsuredField
	...
	@QuoteAndApply
    Scenario: Insure - Hide the fields relating to current insurance
	...
	@QuoteAndApply
    Scenario: Insure - Check the options that are available in insuredStatus
    Given I am on presales /dev/quote-and-apply
    And I see the Quote And Apply page feed load has completed
	...
	@QuoteAndApply
    Scenario: Insure - Check the options that are available in No Of Claim Free Years
    Given I am on presales /dev/quote-and-apply
    And I see the Quote And Apply page feed load has completed
	...
	@QuoteAndApply
    Scenario: Insure - Check the options that are available in No Of Claims
    Given I am on presales /dev/quote-and-apply
    And I see the Quote And Apply page feed load has completed
    And I go to the insuredStatus field and choose currently insured
