Feature: AccountHolderName
    ...
    @QuoteAndApply
    Scenario: Payment Details - Name - Check name field can be populated
	...
	@QuoteAndApply
    Scenario: Payment Details - Name - Check name field can be populated with special character double barrelled name
    Given I am on presales /dev/quote-payment-details
    And I see the Quote And Apply page feed load has completed
	...
	@QuoteAndApply
    Scenario: Payment Details - Name - Check error message when name contains a number
    Given I am on presales /dev/quote-payment-details
    And I see the Quote And Apply page feed load has completed
