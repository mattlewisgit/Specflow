...
namespace Vitality.Website.Areas.Presales.Controllers
{
    public class BaseController : ApiController
    {
        ...
        protected async Task<HttpResponseMessage> GetResponseAsync<TRequest, TResponse>(TRequest request, Predicate<TResponse> isValidResponse) where TRequest : IAsyncRequest<TResponse>
        {
